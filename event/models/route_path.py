...
class RoutePath(models.Model):
    ...
    concentration = models.CharField(max_length=100, default='00:00', verbose_name='Horário de concentração')
    time = models.CharField(max_length=30, verbose_name='Horário de Sáida')
